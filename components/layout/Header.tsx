...
const Header = () => {
  ...
  return (
    <div className={`flex flex-col md:flex-row gap-2 items-center justify-between p-4 z-[100] w-full fixed duration-1000 ${hasScrolled ? 'bg-brand-900' : 'bg-transparent gradient-transparency'}`}>
      <Link href='/'>
